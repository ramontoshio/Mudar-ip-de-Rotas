...
echo  :                            MUDAR IP de Rota Automaticamente                     v2.6.3:
echo  =========================================================================================
echo                                                                                 %data%
...
cls
echo.
echo Atibuindo DNS Marinter, aguarde...
echo.
ipconfig /flushdns
...
echo        --------------------------------------------------------------------------------------
echo    s09 :  IP suporte  :  inserir o ip 23 do suporte interno + DNS MARINTER
echo        --------------------------------------------------------------------------------------
echo.
echo           -----------------------------
...
:s09
cls
netsh interface ip set address "Ethernet" static 10.82.0.23 255.255.255.128 10.82.0.1
ipconfig /flushdns
netsh interface ip set dns "Ethernet" static 177.93.139.163
netsh interface ip add dns "Ethernet" 189.84.80.36
echo.
...
echo ==========================================
echo *                                        *
echo *    IP 10.82.0.23 do SUPORTE INTERNO    *
echo *         e DNS MARINTER                 *
echo *                                        *
echo ==========================================
echo.
